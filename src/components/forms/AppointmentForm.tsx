...
const inputClass =
  "min-h-11 w-full rounded-xl border border-input bg-card px-4 text-base text-ink placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline-2 focus-visible:outline-primary";
