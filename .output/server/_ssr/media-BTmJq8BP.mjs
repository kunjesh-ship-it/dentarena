//#region node_modules/.nitro/vite/services/ssr/assets/media-BTmJq8BP.js
/**
* Clinic gallery.
*
...
var galleryItems = [
	{
		...
		title: "Dent Arena signage",
		caption: "The Dent Arena signboard above the clinic entrance.",
		category: "exterior",
		imageType: "authentic",
		approved: true,
		displayOrder: 1,
	...
	},
	{
		...
		image: {
			src: "/assets/generic-treatment-room-BhDFpvHP.jpg",
	...
	},
	{
		...
		recommendedSize: "1280 × 960 px",
		image: {
			src: "/assets/generic-instruments-D7lniivr.jpg",
	...
	},
	{
		...
		recommendedSize: "1280 × 960 px",
		image: {
			src: "/assets/generic-sterilisation-D_ykyS8N.jpg",
...
function publishableCases(cases = caseStudies) {
	return cases.filter((c) => c.patientConsentApproved === true && c.contentApproved === true && Boolean(c.beforeImage?.src) && Boolean(c.afterImage?.src)).sort((a, b) => a.displayOrder - b.displayOrder);
}
/**
...
function publishableTestimonials(items = testimonials) {
	return items.filter((t) => t.verified === true && t.approved === true);
}
//#endregion
export { testimonials as a, publishableTestimonials as i, galleryItems as n, publishableCases as r, caseStudies as t };
